    ...
    do {
        ...
        switch (codecParameters->codec_id){
            case AV_CODEC_ID_H264:
                m_AVCodec = avcodec_find_decoder_by_name("h264_mediacodec"); //硬解码264
                LOGCATE("DecoderBase::PrepareDecoder avcodec_find_decoder_by_name(\"h264_mediacodec\")");
                if(m_AVCodec == nullptr) {
                    LOGCATE("DecoderBase::PrepareDecoder avcodec_find_decoder_by_name(\"h264_mediacodec\") fail.");
                }
                break;
            case AV_CODEC_ID_MPEG4:
                m_AVCodec = avcodec_find_decoder_by_name("mpeg4_mediacodec"); //硬解码mpeg4
                LOGCATE("DecoderBase::PrepareDecoder avcodec_find_decoder_by_name(\"mpeg4_mediacodec\")");
                if(m_AVCodec == nullptr) {
                    LOGCATE("DecoderBase::PrepareDecoder avcodec_find_decoder_by_name(\"mpeg4_mediacodec\") fail.");
                }
                break;
            case AV_CODEC_ID_HEVC:
                m_AVCodec = avcodec_find_decoder_by_name("hevc_mediacodec"); //硬解码265
                LOGCATE("DecoderBase::PrepareDecoder avcodec_find_decoder_by_name(\"hevc_mediacodec\")");
                if(m_AVCodec == nullptr) {
                    LOGCATE("DecoderBase::PrepareDecoder avcodec_find_decoder_by_name(\"hevc_mediacodec\") fail.");
                }
                break;
            default:
                break;
        ...
        if(m_AVCodec == nullptr) {
            ...
            if(m_AVCodec == nullptr) {
                LOGCATE("DecoderBase::PrepareDecoder avcodec_find_decoder fail.");
                break;
            }
        }
